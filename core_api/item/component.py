...
def get_component_list_action(*, cookies: dict, headers: dict, query_params: dict, path_params: dict, body: dict) -> Response:
    qsp = query_params or {}
    pp = path_params or {}
    body = body or {}
...
def get_component_action(*, cookies: dict, headers: dict, query_params: dict, path_params: dict, body: dict) -> Response:
    qsp = query_params or {}
    pp = path_params or {}
    body = body or {}
...
def create_component_action(*, cookies: dict, headers: dict, query_params: dict, path_params: dict, body: dict) -> Response:
    qsp = query_params or {}
    pp = path_params or {}
    body = body or {}
...
def update_component_action(*, cookies: dict, headers: dict, query_params: dict, path_params: dict, body: dict) -> Response:
    qsp = query_params or {}
    pp = path_params or {}
    body = body or {}
...
def delete_component_action(*, cookies: dict, headers: dict, query_params: dict, path_params: dict, body: dict) -> Response:
    qsp = query_params or {}
    pp = path_params or {}
    body = body or {}
